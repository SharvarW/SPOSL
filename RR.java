...
class RR
{
	public static void main(String args[])throws IOException
	{
		...
		for(int i=0;i<count;i++)
			System.out.print(" P"+gantt_chart[i]);
		System.out.println();
...
/*
OUTPUT : 
sharvari@sharvari-Vostro-15-3568:~/Desktop/SPOSL/Assignment_11$ javac RR.java
sharvari@sharvari-Vostro-15-3568:~/Desktop/SPOSL/Assignment_11$ java RR
...
-------------
Gantt Chart is : 
 P1 P1 P1 P1 P2 P2 P2 P3 P3 P3 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1 P1
sharvari@sharvari-Vostro-15-3568:~/Desktop/SPOSL/Assignment_11$ 
